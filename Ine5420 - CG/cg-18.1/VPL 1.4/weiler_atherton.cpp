...
size_t clip(const edgevertex2f_t& windowShape, edgevertex2f_t& clippedShape, bool clockwise) {
...
size_t WeilerAtherton::clip(const edgevertex2f_t& windowShape, edgevertex2f_t& clippedShape) {
	...
	return ::clip(windowShape, clippedShape, clockwise);
}
